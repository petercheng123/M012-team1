...
def Decode(p1: str) -> str:
    ...
    while p1 != "": # when p1 is not empty
        if first_letter == "1": # if the first number is 1
            ...
            p1 = p1[8:] # replace the 7 digits with empty string, basically removing them out of p1
            ...
            p1 = p1[6:] # replace the 5 digits with an empty string, basically removing them out of p1
...
def decode(p1: str)->str:
    ...
    while p1 != "":
        if first_bin == "1": # if the first number is 1
            ...
            result = result + x  # output result in list called char
            p1 = p1[7:] #makes new p1 without the first bin
        elif first_bin == "0": # if the first number is 1
            first_char = p1[:5] # look at the first 5 digit
