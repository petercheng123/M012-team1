def Code(p1: str) -> str:
    ...
    dictionary = {"a": '00000', "e": '00001', "i": '00010',"o": '00011', "u": '00100', "r": '00101', "s": '00110',
                  ...
                  "h": "1010000", "k": "1100001", "l": "1100010", "m": "1100100", "p": "1101000", "q": "1110000",
  ...
  #char to bin
    bin = []  #this is what will be returned//a count of the converted char into binary and the actual converted char into binary
    for char in p1:  #goes through every char in the string
        if char in dictionary: #checking to see if the char is actuallly given a val in the dictionary
            ...
            #following code concatinates all the binary numbers and takes a count of how many were actually converted
    ...
    return result  #this is the final output// all the chars values as binary in D.B form
